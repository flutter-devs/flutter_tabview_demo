...
main() {
  ...
  runApp(new MaterialApp(
    ...
    routes: <String, WidgetBuilder>{
      ...
      PHOTO_CONTAINER_SCREEN: (BuildContext context) => new PhotoContainerScreen(),
      VIDEO_CONTAINER_SCREEN: (BuildContext context) => new VideoContainerScreen(),
      ALBUM_CONTAINER_SCREEN: (BuildContext context) => new AlbumContainerScreen()
    },
  ));
}
